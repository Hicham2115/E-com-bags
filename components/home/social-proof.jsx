...
const reviews = [
  {
    ...
    date: "3 weeks ago",
    stars: 5,
    fit: ["5'7\" / 170cm", "Daily wear", "Owned 6 months"],
    ...
    reply: {
      from: "Yasmina",
      role: "Founder, Maison Oria",
      text: "Léa — thank you for this. The clasp loosens after the first ten days; mine did the same. If you're ever near one of our stockists, stop in — coffee on us. — Y",
    },
    feature: true,
  },
  {
      ...
      <div className="mx-auto max-w-360 px-[clamp(20px,4vw,60px)] grid grid-cols-1 md:grid-cols-[340px_1fr] gap-12 md:gap-20 items-start">
        ...
        >
          ...
          <h2 className="font-serif text-[clamp(40px,4.8vw,64px)] font-normal leading-[1.02] tracking-[-0.01em] mb-8">
            Two thousand women.
            <br />
            One <em className="italic text-gold">thing in common.</em>
          </h2>

          <div className="flex items-baseline gap-3 mb-2">
            <strong className="font-serif text-[72px] leading-none font-normal">
              4.9
            </strong>
          ...
          {[
            ...
            <div
              key={bar.lab}
              className="flex items-center gap-3 mb-2 text-[11px] text-[rgba(245,240,234,0.7)]"
            >
              ...
              <span className="w-10 text-right text-[rgba(245,240,234,0.4)]">
                {bar.n}
              </span>
            </div>
          ))}
          ...
          <div className="flex flex-wrap gap-4 mt-8 pt-7 border-t border-[rgba(245,240,234,0.1)] text-[10px] tracking-[0.22em] uppercase text-[rgba(245,240,234,0.5)]">
            {["Featured · Vogue", "Editor's Pick · Elle", "The Cut"].map(
              (t) => (
          ...
          {reviews.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-3.5 mb-[18px]">
                ...
                <div className="text-[10px] text-[rgba(245,240,234,0.4)] tracking-[0.06em] whitespace-nowrap">
                  {r.date}
                </div>
              </div>
                ...
                <div className="flex flex-wrap gap-3 mb-4 text-[10px] text-[rgba(245,240,234,0.45)] tracking-[0.06em]">
                  {r.fit.map((f, j) => (
                    <span key={f} className="flex items-center gap-3">
                      {j > 0 && (
                        <span className="w-[3px] h-[3px] rounded-full bg-gold" />
                      )}
                      {f}
                    </span>
                  ))}
              ...
              <h4
                className={`font-serif leading-[1.25] mb-2.5 font-medium text-text-light ${r.feature ? "text-[28px]" : "text-[22px]"}`}
              >
                {r.title}
              </h4>
              <p className="flex-1 mb-4 leading-[1.7] text-sm text-[rgba(245,240,234,0.75)]">
                {r.body}
              </p>
              ...
              {r.color && (
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[rgba(245,240,234,0.12)] mb-3.5 w-fit text-[10px] tracking-[0.15em] uppercase text-[rgba(245,240,234,0.6)]">
                  <span
                    ...
                    style={{ background: swatchBg[r.color] }}
                  />
                  {r.product} ·{" "}
                  <strong className="text-text-light font-medium">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-[rgba(245,240,234,0.08)] text-[10px] tracking-[0.18em] uppercase text-[rgba(245,240,234,0.45)]">
                <span className="text-[rgba(245,240,234,0.7)]">
                  ♡ Helpful · {r.helpful}
                </span>
              </div>
              ...
              {r.reply && (
                <div className="mt-4 p-3.5 rounded-r-xs border-l-2 border-gold bg-[rgba(201,169,110,0.06)]">
                  <div className="flex items-center gap-2.5 mb-2 text-[10px] tracking-[0.2em] uppercase">
                    <span className="w-5 h-5 rounded-full bg-gold text-oria-text flex items-center justify-center text-[11px] font-serif">
                      O
                    </span>
                    <span className="text-text-light">{r.reply.from}</span>
                    <span className="text-[rgba(245,240,234,0.4)]">
                      {r.reply.role}
                    </span>
                  </div>
                  <p className="font-serif italic text-sm text-[rgba(245,240,234,0.8)] leading-[1.6]">
                    {r.reply.text}
                  </p>
                </div>
              )}
