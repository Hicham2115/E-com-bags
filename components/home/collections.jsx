...
const collectionImages = [col01, col02, col03];
  ...
  return (
    <section className="py-[clamp(80px,12vw,160px)] overflow-hidden">
      ...
      >
        ...
        >
          <Image src={collectionImages[0]} alt="Atlas" fill placeholder="blur" quality={70} sizes="(max-width: 768px) 100vw, 60vw" className="object-cover object-center transition-transform duration-1400 group-hover:scale-[1.05]" />
        ...
        >
          <Image src={collectionImages[1]} alt="Sac Luna" fill placeholder="blur" quality={70} sizes="(max-width: 768px) 100vw, 40vw" className="object-cover object-center transition-transform duration-1400 group-hover:scale-[1.04]" />
        ...
        >
          <Image src={collectionImages[2]} alt="Medina" fill placeholder="blur" quality={70} sizes="(max-width: 768px) 100vw, 40vw" className="object-cover object-center transition-transform duration-1400 group-hover:scale-[1.04]" />
          <div className="absolute inset-0 z-1 bg-black/15" />
          <div
            className="absolute inset-0 z-1"
