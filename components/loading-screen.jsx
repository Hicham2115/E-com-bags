...
export default function LoadingScreen() {
  ...
  useEffect(() => {
    ...
    tl
      ...
      .to(ornamentRef.current, { opacity: 1, scale: 1, duration: 0.35, ease: "power2.out" })
      // Divider line expands
      .to(dividerRef.current, { scaleX: 1, duration: 0.3, ease: "power2.inOut" }, "-=0.15")
      // "MAISON" rises from clip
      .to(maisonRef.current, { yPercent: 0, opacity: 1, duration: 0.4, ease: "power3.out" }, "-=0.12")
      // "ORIA" follows slightly behind
      .to(oriaRef.current, { yPercent: 0, opacity: 1, duration: 0.4, ease: "power3.out" }, "-=0.28")
      // Tagline
      .to(taglineRef.current, { yPercent: 0, opacity: 1, duration: 0.3, ease: "power2.out" }, "-=0.16")
      // Progress bar
      .to(progressBarRef.current, { scaleX: 1, duration: 0.55, ease: "power1.inOut" }, "-=0.08")
