    ...
    >
      <Link href={`/products/${p.handle}`} className="block">
        <div className="relative aspect-[4/5] overflow-hidden bg-[var(--ivory-2)] rounded-sm mb-[18px]">
          ...
          >
            {hasImages ? (
              <Image src={img1} alt={p.name} fill className="object-cover" quality={70} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
            ) : (
          ...
          >
            {hasImages ? (
              <Image src={img2} alt={p.name} fill className="object-cover" quality={70} sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw" />
            ) : (
