...
export function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 px-[clamp(20px,4vw,60px)] transition-all duration-500 bg-[rgb(249,248,247)] backdrop-blur-[20px] saturate-150 border-b border-black/[0.06] ${
          scrolled ? "py-[7px]" : "py-3"
        }`}
      >
